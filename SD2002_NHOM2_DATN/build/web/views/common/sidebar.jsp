...
<aside class="sidebar">
    ...
    <ul class="menu">
        ...
        <!-- Dòng debug này sẽ hiện quyền lên giao diện để bạn kiểm tra -->
        <li style="color:red; padding: 10px;">Quyền đang nhận: ${sessionScope.QuyenHan}</li>

        <%-- Các mục chỉ hiện khi có quyền tương ứng (hoặc là Admin) --%>
        <c:if test="${fn:contains(userQuyen, 'Admin')}">
            <li>
                <a href="#" class="menu-item ${param.activePage == '1' ? 'active' : ''}">
        ...
        <c:if test="${fn:contains(userQuyen, 'Inventory Manager') or fn:contains(userQuyen, 'Admin')}">
            <li>
        ...
        <c:if test="${fn:contains(userQuyen, 'Equipment Manager') or fn:contains(userQuyen, 'Admin')}">
            <li>
        ...
        <c:if test="${fn:contains(userQuyen, 'HR Manager') or fn:contains(userQuyen, 'Admin')}">
            <li>
        ...
        <c:if test="${fn:contains(userQuyen, 'Technician') or fn:contains(userQuyen, 'Admin')}">
            <li>
        ...
        <c:if test="${fn:contains(userQuyen, 'Worker') or fn:contains(userQuyen, 'Admin')}">
            <li>
                <a href="#" class="menu-item ${param.activePage == 'us7' ? 'active' : ''}">
