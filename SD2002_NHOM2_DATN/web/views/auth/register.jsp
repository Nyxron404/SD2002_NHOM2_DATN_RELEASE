...
<html lang="vi">
    <head>
        ...
        <title>Smart Farmer - Đăng ký</title>
        <style>
            body {
                margin: 0;
                height: 100vh;
                ...
                gap: 35px; /* Tăng khoảng cách để phù hợp với chữ lớn hơn */
            }
            ...
            <form method="Post" action="${pageContext.request.contextPath}/auth">
                <table>
                    <tr>
                        <td>
                            <div class="input-group">
                                <input type="text" lang="en" pattern="[A-Za-z0-9]+" title="Tên tài khoản không hợp lệ." class="ten-dk" name="TenDangKy" placeholder="Nhập tên tài khoản" required>
                    ...
                    <tr>
                        <td>
                            <div class="input-group">
                                <input type="email" class="email-dk" name="EmailDangKy"  placeholder="Nhập email" required>
